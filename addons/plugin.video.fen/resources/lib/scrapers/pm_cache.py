...
from modules.source_utils import get_file_info, supported_video_extensions, internal_results, check_title, get_aliases_titles, seas_ep_filter, release_info_format
...
class PremiumizeSource:
	def __init__(self):
		...
		self.enabled = enabled_debrids_check('pm')
		self.title_filter = filter_by_name('pm-cloud')
