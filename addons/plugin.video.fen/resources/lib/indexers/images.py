...
from modules.kodi_utils import translate_path, notification, window, make_listitem, list_dirs, delete_file
...
class Images():
	...
	def delete_image(self):
		...
		window.setProperty('fen.home_window.delete_image_finished', 'true')
